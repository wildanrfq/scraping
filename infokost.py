	...
	try:
		...
		for kost in data.findAll("div",class_="box-search"):
			...
			for kamar in info.find("div",class_="container-detail").findAll("div",class_="room-row"):
				...
				kamarr.append({"kamar":kamarw,"fasilitas":fasilitas,"images":images,"desc":desc,"harga":harga})
			dataa.append({"title":title,"link":link,"alamat":alamat,"fullDesc":fulldesc,"kamar":kamarr})
		h.pj(dataa)
